...
public enum SpellweaverSets implements SetEnumInterface {
    ...
    BLACK_ESSENCE_ARMAMENT("Black Essence Armament", Map.of(2, List.of(new OverallAbsolutBuff(AbsoluteStatType.RESISTANCE, 2044.0)), 3, List.of(new OverallDescriptionBuff("Essence cost reduced by 1")), 4, List.of(new OverallAbsolutBuff(AbsoluteStatType.MANA, 19.0)), 5, List.of(new OverallDescriptionBuff("Ess cost 0 with 15% chance"))), 140),
