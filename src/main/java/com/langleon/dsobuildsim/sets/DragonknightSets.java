...
public enum DragonknightSets implements SetEnumInterface {
    ...
    MACHINE_POWER("Machine Power", Map.of(2, List.of(new OverallAbsolutBuff(AbsoluteStatType.DAMAGE, 4165.0)), 3, List.of(new OverallAbsolutBuff(AbsoluteStatType.CRIT_VALUE, 4331.0)), 4, List.of(new OverallAbsolutBuff(AbsoluteStatType.ATTACK_SPEED, 0.214)), 5, List.of(new OverallAbsolutBuff(AbsoluteStatType.MANA, 29.0))), 145),
    ...
    KRANPARUS_TREASURES("Kranparus' Treasureas", Map.of(1, List.of(new OverallAbsolutBuff(AbsoluteStatType.HEALTH_POINTS, 67615.0)), 2, List.of(new OverallAbsolutBuff(AbsoluteStatType.DAMAGE, 1248.0)), 3, List.of(new OverallAbsolutBuff(AbsoluteStatType.CRIT_VALUE, 4677.0))), 140),
    ;
