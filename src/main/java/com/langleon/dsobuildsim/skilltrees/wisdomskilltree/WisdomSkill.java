...
public enum WisdomSkill {
    ...
    HARD_AS_A_ROCK("Hard as a Rock", 80, 3, 545.0,  AbsoluteStatType.ARMOR, false, 0.0, ""),
    ELEMENTAL_PROTECTION("Elemental Protection", 80, 3, 545.0,  AbsoluteStatType.RESISTANCE, false, 0.0, ""),
