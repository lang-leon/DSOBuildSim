...
public enum WisdomSkill {
    ...
    RISING_VIGOR("Rising Vigor", 60, 3, 3250.0, StatType.HEALTH_POINTS, false, 0.0, ""),
    VIVACIOUS_VITALITY("Vivacious Vitality", 60, 3, 165.0,  StatType.HEALTH_PER_SECOND, false, 0.0, ""),
    CONJURED_DISTILLATION("Conjured Distillation", 60, 3, 1.0,  StatType.MANA, false, 0.0, ""),
    RISING_POWER("Rising Power", 80, 3, 75.0,  StatType.DAMAGE, false, 0.0, ""),
    DECISIVE_STRIKE("Decisive Strike", 80, 3, 845.0,  StatType.CRIT_VALUE, false, 0.0, ""),
    HANGMANS_PRIDE("Hangman's Pride", 80, 3, 165.0 , false, 0.0, "Regenerates %f Health Points per final Blow"),
    STURDY_SHIELD("Sturdy Shield", 80, 3, 845.0,  StatType.BLOCK_VALUE, false, 0.0, ""),
    HARD_AS_A_ROCK("Hard as a Rock", 80, 3, 545.0,  StatType.ARMOR_VALUE, false, 0.0, ""),
    ELEMENTAL_PROTECTION("Elemental Protection", 80, 3, 545.0,  StatType.RESISTANCE_VALUE, false, 0.0, ""),
    ...
    DEXTROUS_SMITING("Dextrous Smiting", 60, 3, 100.0,  StatType.ONE_HAND_DAMAGE, false, 0.0, ""),
    DEXTROUS_AGILITY("Dextrous Agility", 60, 3, 0.01,  StatType.ONE_HAND_ATTACK_SPEED, false, 0.0, ""),
    ...
    AMBIDEXTROUS_SMITING("Ambidextrous Smiting", 60, 3, 200.0,  StatType.TWO_HAND_DAMAGE, false, 0.0, ""),
    AMBIDEXTROUS_AGILITY("Ambidextrous Agility", 60, 3, 0.005,  StatType.TWO_HAND_ATTACK_SPEED, false, 0.0, ""),
    ...
    BONANZA("Bonanza", 150, 1, 0.007, StatType.COIN_DROP_BONUS,false, 0.01, ""),
    ...
    private final StatType relativeBuffType;
    private final boolean biggerIncreaseWithFirstLevel;
    private final Double firstLevelBoost;
    private int currentLevel;
    private final String description;

    WisdomSkill(String name, int maxLevel, int costPerLevel, Double increasePerLevel, StatType statType, boolean biggerIncreaseWithFirstLevel, Double firstLevelBoost, String description)
    {
        this.name = name;
    ...
    public StatType getRelativeBuffType() {
