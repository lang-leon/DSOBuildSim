...
public enum SpellweaverMythicItem implements Item {
    ...
    OLD_GLORY("Old Glory", ItemType.CLOAK, Map.of(AbsoluteStatType.DAMAGE, 1891.513, AbsoluteStatType.ATTACK_SPEED, 0.06, AbsoluteStatType.HEALTH_POINTS, 16507.200), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffType.DAMAGE, 0.1)),145),
    RING_OF_OLD_GLORY("Ring of Old Glory", ItemType.RING, Map.of(AbsoluteStatType.DAMAGE, 1891.513, AbsoluteStatType.CRIT_VALUE, 1753.505, AbsoluteStatType.HEALTH_POINTS, 24760.80), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffType.DAMAGE, 0.05), new OverallRelativeBuff(OverallRelativeBuffType.CRIT_VALUE, 0.05)),145),
    ANCESTRAL_GLORY_CLOAK("Ancestral Glory Cloak (Mage)", ItemType.CLOAK, Map.of(AbsoluteStatType.DAMAGE, 1891.513, AbsoluteStatType.ATTACK_SPEED, 0.06, AbsoluteStatType.HEALTH_POINTS, 16507.200), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffType.DAMAGE, 0.1), new OverallAbsolutBuff(AbsoluteStatType.DAMAGE, 5000.0)),15),
    RING_OF_ANCESTRAL_GLORY("Ancestral Glory Ring", ItemType.RING, Map.of(AbsoluteStatType.DAMAGE, 1891.513, AbsoluteStatType.CRIT_VALUE, 1753.505, AbsoluteStatType.HEALTH_POINTS, 24760.80), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffType.DAMAGE, 0.1), new OverallRelativeBuff(OverallRelativeBuffType.CRIT_VALUE, 0.1)),145);
    ...
    SpellweaverMythicItem(String name, ItemType itemType, Map<AbsoluteStatType, Double> baseStats, Map<AbsoluteStatType, Double> uniqueBaseStats, List<UniqueEnchant> uniqueEnchants, List<OverallBuff> overallBuffs, int itemLevel) {
