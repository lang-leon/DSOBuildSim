...
public enum RangerMythicItem implements Item {
    ...
    RangerMythicItem(String name, ItemType itemType, Map<AbsoluteStatType, Double> baseStats, Map<AbsoluteStatType, Double> uniqueBaseStats, List<UniqueEnchant> uniqueEnchants, List<OverallBuff> overallBuffs, int itemLevel) {
