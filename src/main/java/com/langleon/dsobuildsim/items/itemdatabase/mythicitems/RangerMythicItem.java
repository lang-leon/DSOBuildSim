...
public enum RangerMythicItem implements Item {
    ...
    ANCESTRAL_GLORY_CLOAK("Ancestral Glory Cloak (Ranger)", ItemSlotType.CLOAK, Map.of(StatType.DAMAGE, 1891.513, StatType.ATTACK_SPEED, 0.06, StatType.HEALTH_POINTS, 49521.596), Map.of(), List.of(), List.of(new OverallRelativeBuff(StatType.DAMAGE, 0.1), new OverallAbsolutBuff(StatType.DAMAGE, 5000.0)),145),
    ...
    RangerMythicItem(String name, ItemSlotType itemSlotType, Map<StatType, Double> baseStats, Map<StatType, Double> uniqueBaseStats, List<UniqueEnchant> uniqueEnchants, List<OverallBuff> overallBuffs, int itemLevel) {
    ...
    public MythicItem getItem() {
        return new MythicItem(this.name, CharacterClass.RANGER, this.itemSlotType, this.baseStats, this.uniqueBaseStats, this.uniqueEnchants, this.overallBuffs, this.itemLevel, this.set);
    }
