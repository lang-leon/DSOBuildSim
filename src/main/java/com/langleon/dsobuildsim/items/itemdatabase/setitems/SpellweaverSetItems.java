...
public enum SpellweaverSetItems implements Item {
    ...
    MIGHTY_WRATHFUL_SEEKERS_HELMET("Mighty Wrathful Seeker's Helmet", ItemType.HELMET, Map.of(AbsoluteStatType.HEALTH_POINTS, 20185.0, AbsoluteStatType.ARMOR, 1068.0, AbsoluteStatType.FIRE_RESISTANCE, 4150.0), 140),
    ...
    SARGONS_TORSO("Sargon's Torso", ItemType.TORSO, Map.of(AbsoluteStatType.DAMAGE, 1644.883, AbsoluteStatType.HEALTH_POINTS, 16507.0, AbsoluteStatType.ARMOR, 1648.0), 145),
    ...
    AMULET_OF_DEATH("Amulet of Death", ItemType.AMULET, Map.of(AbsoluteStatType.DAMAGE, 1644.883, AbsoluteStatType.CRIT_VALUE, 1754.0, AbsoluteStatType.RESISTANCE, 1162.0), 145),
    CAP_OF_DEATH("Cap of Death", ItemType.HELMET, Map.of(AbsoluteStatType.DAMAGE, 1644.883, AbsoluteStatType.CRIT_VALUE, 1754.0, AbsoluteStatType.RESISTANCE, 1162.0), 145),

    BLACK_ESSENCE_HELMET("Black Essence Helmet", ItemType.HELMET, Map.of(AbsoluteStatType.DAMAGE, 1601.0, AbsoluteStatType.HEALTH_POINTS, 20185.0, AbsoluteStatType.ARMOR, 1068.0), 140),
    BLACK_ESSENCE_PAULDRONS("Black Essence Pauldrons", ItemType.SHOULDERS, Map.of(AbsoluteStatType.HEALTH_POINTS, 16145.0, AbsoluteStatType.ARMOR, 1068.0, AbsoluteStatType.RESISTANCE, 1131.0), 140),
    BLACK_ESSENCE_ARMOR("Black Essence Armor", ItemType.TORSO, Map.of(AbsoluteStatType.DAMAGE, 1601.0, AbsoluteStatType.HEALTH_POINTS, 16145.0, AbsoluteStatType.ARMOR, 1603.0), 140),
    BLACK_ESSENCE_GLOVES("Black Essence Gloves", ItemType.GLOVES, Map.of(AbsoluteStatType.DAMAGE, 1601.0, AbsoluteStatType.ATTACK_SPEED, 0.054, AbsoluteStatType.ARMOR, 1068.0), 140),
    ...
    AUTOMATED_SHOULDERGUARDS("Automated Shoulderguards", ItemType.SHOULDERS, Map.of(AbsoluteStatType.HEALTH_POINTS, 16507.0, AbsoluteStatType.ARMOR, 1098.0, AbsoluteStatType.RESISTANCE, 1162.0), 145),
    AUTOMATED_STERNUM_GUARD("Automated Sternum Guard", ItemType.TORSO, Map.of(AbsoluteStatType.DAMAGE, 1645.0, AbsoluteStatType.HEALTH_POINTS, 16507.0, AbsoluteStatType.ARMOR, 1648.0), 145),
    ...
    AUTOMATED_BELT("Automated Belt", ItemType.BELT, Map.of(AbsoluteStatType.DAMAGE, 1645.0, AbsoluteStatType.HEALTH_POINTS, 24761.0, AbsoluteStatType.RESISTANCE, 1743.0), 145),
