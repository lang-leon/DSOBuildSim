...
import kaukasus.Sets.SteamMechanicusSets;
...
public enum SteamMechanicusMythicItem implements Item {
    ...
    OLD_GLORY("Old Glory", ItemTypeEnum.CLOAK, Map.of(AbsoluteStatTypeEnum.DAMAGE, 1891.513, AbsoluteStatTypeEnum.ATTACK_SPEED, 0.06, AbsoluteStatTypeEnum.HEALTH_POINTS, 28887.598), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffTypeEnum.DAMAGE, 0.1)),145),
    RING_OF_OLD_GLORY("Ring of Old Glory", ItemTypeEnum.RING, Map.of(AbsoluteStatTypeEnum.DAMAGE, 1891.513, AbsoluteStatTypeEnum.CRIT_VALUE, 1753.505, AbsoluteStatTypeEnum.HEALTH_POINTS, 43331.404), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffTypeEnum.DAMAGE, 0.05), new OverallRelativeBuff(OverallRelativeBuffTypeEnum.CRIT_VALUE, 0.05)),145),
    ANCESTRAL_GLORY_CLOAK("Ancestral Glory Cloak (Steam Mechanicus)", ItemTypeEnum.CLOAK, Map.of(AbsoluteStatTypeEnum.DAMAGE, 1891.513, AbsoluteStatTypeEnum.ATTACK_SPEED, 0.06, AbsoluteStatTypeEnum.HEALTH_POINTS, 28887.598), Map.of(), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffTypeEnum.DAMAGE, 0.1), new OverallAbsolutBuff(AbsoluteStatTypeEnum.DAMAGE, 5000.0)),145),
    ...
    SteamMechanicusMythicItem(String name, ItemTypeEnum itemType, Map<AbsoluteStatTypeEnum, Double> baseStats, Map<AbsoluteStatTypeEnum, Double> uniqueBaseStats, List<UniqueEnchant> uniqueEnchants, List<OverallBuff> overallBuffs, int itemLevel) {
        this.characterClass = CharacterClassEnum.STEAM_MECHANICUS;
        this.name = name;
