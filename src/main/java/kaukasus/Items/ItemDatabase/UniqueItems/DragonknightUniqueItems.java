...
public enum DragonknightUniqueItems implements Item {
    ...
    SARGONS_SHADOW_AMULET("Sargon's Shadow Amulet", ItemTypeEnum.AMULET, Map.of(AbsoluteStatTypeEnum.DAMAGE, 1601.0, AbsoluteStatTypeEnum.MOVEMENT_SPEED, 0.489, AbsoluteStatTypeEnum.HEALTH_POINTS, 74282.0), Map.of(AbsoluteStatTypeEnum.DAMAGE, 3771.0), List.of(), List.of(), 140),
    KINGSHILLS_NECKLACE("Kingshill Necklace", ItemTypeEnum.AMULET, Map.of(AbsoluteStatTypeEnum.HEALTH_PER_SECOND, 74283.0, AbsoluteStatTypeEnum.RESISTANCE, 1162.0, AbsoluteStatTypeEnum.BLOCK_VALUE, 1897.0), Map.of(AbsoluteStatTypeEnum.HEALTH_POINTS, 43615.0), List.of(), List.of(), 145),
    GRAND_MASTERS_ARMOR("Grand Master's Armor", ItemTypeEnum.TORSO, Map.of(AbsoluteStatTypeEnum.HEALTH_POINTS, 48435.0, AbsoluteStatTypeEnum.ARMOR, 1603.0, AbsoluteStatTypeEnum.RESISTANCE, 1697.0), Map.of(AbsoluteStatTypeEnum.HEALTH_PER_SECOND, 3615.886), List.of(), List.of(new OverallRelativeBuff(OverallRelativeBuffTypeEnum.HEALTH_POINTS, 0.05)), 140),
    GRAND_MASTERS_GLOVES("Grand Master's Gloves", ItemTypeEnum.GLOVES, Map.of(AbsoluteStatTypeEnum.MOVEMENT_SPEED, 0.484, AbsoluteStatTypeEnum.ARMOR, 1068.0, AbsoluteStatTypeEnum.RESISTANCE, 1131.0), Map.of(), List.of(new UniqueEnchant(EnchantTypeEnum.RESISTANCE, 0.27198)), List.of(new OverallRelativeBuff(OverallRelativeBuffTypeEnum.ARMOR, 0.1)), 140),
    JUSTICE("Justice", ItemTypeEnum.OFF_HAND, Map.of(AbsoluteStatTypeEnum.HEALTH_POINTS, 99067.0, AbsoluteStatTypeEnum.ARMOR, 2197.0, AbsoluteStatTypeEnum.BLOCK_VALUE, 47683.0), Map.of(AbsoluteStatTypeEnum.HEALTH_POINTS, 44463.0), List.of(), List.of(), 145),
    ;
