...
public enum SpellweaverMythicItem implements Item {
    ...
    public MythicItem getItem() {
        return new MythicItem(this.name, CharacterClassEnum.SPELLWEAVER, this.itemType, this.baseStats, this.uniqueBaseStats, this.uniqueEnchants, this.overallBuffs, this.itemLevel, this.set);
    }
