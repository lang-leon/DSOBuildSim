...
public enum RangerMythicItem implements Item {
    ...
    public MythicItem getItem() {
        return new MythicItem(this.name, CharacterClassEnum.RANGER, this.itemType, this.baseStats, this.uniqueBaseStats, this.uniqueEnchants, this.overallBuffs, this.itemLevel, this.set);
    }
