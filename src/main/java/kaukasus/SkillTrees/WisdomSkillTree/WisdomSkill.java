...
public enum WisdomSkill {
    ...
    RISING_VIGOR("Rising Vigor", 60, 3, 3250.0, AbsoluteStatTypeEnum.HEALTH_POINTS, false, 0.0, ""),
    VIVACIOUS_VITALITY("Vivacious Vitality", 60, 3, 165.0,  AbsoluteStatTypeEnum.HEALTH_PER_SECOND, false, 0.0, ""),
    CONJURED_DISTILLATION("Conjured Distillation", 60, 3, 1.0,  AbsoluteStatTypeEnum.MANA, false, 0.0, ""),
    RISING_POWER("Rising Power", 80, 3, 75.0,  AbsoluteStatTypeEnum.DAMAGE, false, 0.0, ""),
    DECISIVE_STRIKE("Decisive Strike", 80, 3, 845.0,  AbsoluteStatTypeEnum.CRIT_VALUE, false, 0.0, ""),
    HANGMANS_PRIDE("Hangman's Pride", 80, 3, 165.0 , false, 0.0, "Regenerates %f Health Points per final Blow"),
    STURDY_SHIELD("Sturdy Shield", 80, 3, 845.0,  AbsoluteStatTypeEnum.BLOCK_VALUE, false, 0.0, ""),
    HARD_AS_A_ROCK("Hard as a Rock", 80, 3, 545.0,  AbsoluteStatTypeEnum.ARMOR, false, 0.0, ""),
    ELEMENTAL_PROTECTION("Elemental Protection", 80, 3, 545.0,  AbsoluteStatTypeEnum.RESISTANCE, false, 0.0, ""),
    ...
    DEXTROUS_SMITING("Dextrous Smiting", 60, 3, 100.0,  AbsoluteStatTypeEnum.ONE_HAND_DAMAGE, false, 0.0, ""),
    DEXTROUS_AGILITY("Dextrous Agility", 60, 3, 0.01,  AbsoluteStatTypeEnum.ONE_HAND_ATTACK_SPEED, false, 0.0, ""),
    ...
    AMBIDEXTROUS_SMITING("Ambidextrous Smiting", 60, 3, 200.0,  AbsoluteStatTypeEnum.TWO_HAND_DAMAGE, false, 0.0, ""),
    AMBIDEXTROUS_AGILITY("Ambidextrous Agility", 60, 3, 0.005,  AbsoluteStatTypeEnum.TWO_HAND_ATTACK_SPEED, false, 0.0, ""),
    ...
    BONANZA("Bonanza", 150, 1, 0.007, OverallRelativeBuffTypeEnum.COIN_DROP_BONUS,false, 0.01, ""),
    ...
    private final AbsoluteStatTypeEnum statType;
    private final OverallRelativeBuffTypeEnum relativeBuffType;
    private final boolean biggerIncreaseWithFirstLevel;
    private final Double firstLevelBoost;
    private int currentLevel;
    private final String description;

    WisdomSkill(String name, int maxLevel, int costPerLevel, Double increasePerLevel, AbsoluteStatTypeEnum statType, boolean biggerIncreaseWithFirstLevel, Double firstLevelBoost, String description)
    {
        this.name = name;
    ...
    WisdomSkill(String name, int maxLevel, int costPerLevel, Double increasePerLevel, OverallRelativeBuffTypeEnum relativeBuffType, boolean biggerIncreaseWithFirstLevel, Double firstLevelBoost, String description)
    {
        this.name = name;
        this.maxLevel = maxLevel;
        this.costPerLevel = costPerLevel;
    ...
    public AbsoluteStatTypeEnum getStatType() {
        return statType;
    }

    public OverallRelativeBuffTypeEnum getRelativeBuffType() {
