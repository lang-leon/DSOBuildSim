...
import kaukasus.SkillTrees.AbstractSkillTree;
...
public class WisdomSkillTree extends AbstractSkillTree {
    ...
    public Map<AbsoluteStatTypeEnum, Double> getAbsoluteBuffs()
    {
        Map<AbsoluteStatTypeEnum, Double> absoluteBuffs = new HashMap<>();
        absoluteBuffs.put(AbsoluteStatTypeEnum.HEALTH_POINTS, this.healthResource.getSkill(1).getCurrentLevel()*this.healthResource.getSkill(1).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.HEALTH_PER_SECOND, this.healthResource.getSkill(2).getCurrentLevel()*this.healthResource.getSkill(2).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.MANA, this.healthResource.getSkill(3).getCurrentLevel()*this.healthResource.getSkill(3).getIncreasePerLevel());

        absoluteBuffs.put(AbsoluteStatTypeEnum.DAMAGE, this.attack.getSkill(1).getCurrentLevel()*this.attack.getSkill(1).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.CRIT_VALUE, this.attack.getSkill(2).getCurrentLevel()*this.attack.getSkill(2).getIncreasePerLevel());

        absoluteBuffs.put(AbsoluteStatTypeEnum.BLOCK_VALUE, this.defense.getSkill(1).getCurrentLevel()*this.defense.getSkill(1).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.ARMOR, this.defense.getSkill(2).getCurrentLevel()*this.defense.getSkill(2).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.RESISTANCE, this.defense.getSkill(3).getCurrentLevel()*this.defense.getSkill(3).getIncreasePerLevel());

        absoluteBuffs.put(AbsoluteStatTypeEnum.ONE_HAND_DAMAGE, this.oneHandedWeapon.getSkill(1).getCurrentLevel()*this.oneHandedWeapon.getSkill(1).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.ONE_HAND_ATTACK_SPEED, this.oneHandedWeapon.getSkill(2).getCurrentLevel()*this.oneHandedWeapon.getSkill(2).getIncreasePerLevel());

        absoluteBuffs.put(AbsoluteStatTypeEnum.TWO_HAND_DAMAGE, this.twoHandedWeapon.getSkill(1).getCurrentLevel()*this.twoHandedWeapon.getSkill(1).getIncreasePerLevel());
        absoluteBuffs.put(AbsoluteStatTypeEnum.TWO_HAND_ATTACK_SPEED, this.twoHandedWeapon.getSkill(2).getCurrentLevel()*this.twoHandedWeapon.getSkill(2).getIncreasePerLevel());

        return absoluteBuffs;
    }

    public Map<OverallRelativeBuffTypeEnum, Double> getRelativeBuffs()
    {
        WisdomSkill coins = this.prosperity.getSkill(1);
        return Map.of(OverallRelativeBuffTypeEnum.COIN_DROP_BONUS, coins.getCurrentLevel()*coins.getIncreasePerLevel()+coins.getFirstLevelBoost());
    }
}
