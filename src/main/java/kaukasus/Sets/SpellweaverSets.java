...
public enum SpellweaverSets implements SetEnumInterface {
    ...
    KRANPARUS_TREASURES("Kranparus' Treasures", Map.of(1, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.HEALTH_POINTS, 39954.0)), 3, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.DAMAGE, 1248.0), new OverallAbsolutBuff(AbsoluteStatTypeEnum.CRIT_VALUE, 4677.0))), 145),
    AT_DEATHS_DOOR("At Death's Door", Map.of(2, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.MANA, 19.0), new OverallRelativeBuff(OverallRelativeBuffTypeEnum.DAMAGE, 5.0), new OverallRelativeBuff(OverallRelativeBuffTypeEnum.HEALTH_POINTS, -2.5))), 145),
    BLACK_ESSENCE_ARMAMENT("Black Essence Armament", Map.of(2, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.RESISTANCE, 2044.0)), 3, List.of(new OverallDescriptionBuff("Essence cost reduced by 1")), 4, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.MANA, 19.0)), 5, List.of(new OverallDescriptionBuff("Ess cost 0 with 15% chance"))), 140),
    AUTOMATED_UNIT("Automated Unit", Map.of(2, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.DAMAGE, 4165.0)), 3, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.CRIT_VALUE, 4331.0)), 4, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.ATTACK_SPEED, 0.214)), 5, List.of(new OverallAbsolutBuff(AbsoluteStatTypeEnum.MANA, 29.0))), 145),
