...
public class UniqueItemTest {
    public static void main(String[] args) {
        ...
        UniqueItem setItem = new UniqueItem("Researcher's Boots", CharacterClassEnum.SPELLWEAVER, ItemTypeEnum.BOOTS, baseStats, uniqueBaseStats, uniqueEnchants, overallBuffs, 145);
