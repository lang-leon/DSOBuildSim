...
public class RealWarTest {
    ...
    public static Character normalWar() {
        ...
        Map<StatType, Double> amuletBaseStats = new HashMap<>();
        amuletBaseStats.put(StatType.DAMAGE, 1535.152);
        amuletBaseStats.put(StatType.CRIT_VALUE, 1627.546);
        amuletBaseStats.put(StatType.HEALTH_POINTS, 43467.97);
        ...
        amulet.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        amulet.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        amulet.addGem(new Gem(StatType.DAMAGE, 700.0));
        amulet.addGem(new Gem(StatType.DAMAGE, 700.0));
        amulet.addGem(new Gem(StatType.DAMAGE, 700.0));
        amulet.addGem(new Gem(StatType.DAMAGE, 700.0));
        amulet.addGem(new Gem(StatType.DAMAGE, 700.0));
        ...
        cloak.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        cloak.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        cloak.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        cloak.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        cloak.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        cloak.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        cloak.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        ...
        Map<StatType, Double> beltBaseStats = new HashMap<>();
        beltBaseStats.put(StatType.DAMAGE, 1488.589);
        beltBaseStats.put(StatType.HEALTH_POINTS, 53493.572);
        beltBaseStats.put(StatType.RESISTANCE_VALUE, 1595.500);
        ...
        belt.addGem(new Gem(StatType.DAMAGE, 700.0));
        belt.addGem(new Gem(StatType.DAMAGE, 700.0));
        belt.addGem(new Gem(StatType.DAMAGE, 700.0));
        belt.addGem(new Gem(StatType.DAMAGE, 700.0));
        belt.addGem(new Gem(StatType.DAMAGE, 700.0));
        ...
        ring1.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        ring1.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        ring1.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring1.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring1.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring1.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring1.addGem(new Gem(StatType.DAMAGE, 700.0));
        ...
        ring2.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        ring2.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        ring2.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring2.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring2.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring2.addGem(new Gem(StatType.DAMAGE, 700.0));
        ring2.addGem(new Gem(StatType.DAMAGE, 700.0));
        ...
        helmet.addEnchant(new Enchant(EnchantType.HEALTH_POINTS, 0.44537));
        helmet.addEnchant(new Enchant(EnchantType.HEALTH_POINTS, 0.44537));
        helmet.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        helmet.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        helmet.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        helmet.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        helmet.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        ...
        shoulders.addEnchant(new Enchant(EnchantType.HEALTH_POINTS, 0.44537));
        shoulders.addEnchant(new Enchant(EnchantType.HEALTH_POINTS, 0.44537));
        shoulders.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        shoulders.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        shoulders.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        shoulders.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        shoulders.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        ...
        Map<StatType, Double> torsoBaseStats = new HashMap<>();
        torsoBaseStats.put(StatType.DAMAGE, 1339.327);
        torsoBaseStats.put(StatType.HEALTH_POINTS, 47564.308);
        torsoBaseStats.put(StatType.ARMOR_VALUE, 1130.479);
        ...
        torso.addEnchant(new Enchant(EnchantType.HEALTH_POINTS, 0.44537));
        torso.addEnchant(new Enchant(EnchantType.HEALTH_POINTS, 0.44537));
        torso.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        torso.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        torso.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        torso.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        torso.addGem(new Gem(StatType.HEALTH_POINTS, 5500.0));
        ...
        Map<StatType, Double> glovesBaseStats = new HashMap<>();
        glovesBaseStats.put(StatType.DAMAGE, 1413.061);
        glovesBaseStats.put(StatType.ATTACK_SPEED, 0.046);
        glovesBaseStats.put(StatType.CRIT_VALUE, 1540.514);
        ...
        gloves.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        gloves.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        gloves.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        gloves.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        gloves.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        ...
        Map<StatType, Double> bootsBaseStats = new HashMap<>();
        bootsBaseStats.put(StatType.DAMAGE, 1544.042);
        bootsBaseStats.put(StatType.MOVEMENT_SPEED, 1.132);
        bootsBaseStats.put(StatType.CRIT_VALUE, 1226.948);
        ...
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.17));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 0.13));
        boots.addGem(new Gem(StatType.MOVEMENT_SPEED, 2520.0));
        boots.addGem(new Gem(StatType.CRIT_VALUE, 2520.0));
        dragonknight.addItem(boots, ItemSlot.BOOTS);

        Map<StatType, Double> adornmentBaseStats = new HashMap<>();
        adornmentBaseStats.put(StatType.DAMAGE, 1856.008);
        adornmentBaseStats.put(StatType.ATTACK_SPEED, 0.052);
        adornmentBaseStats.put(StatType.CRIT_VALUE, 1991.931);
        ...
        adornment.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        adornment.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        Opal opal = new Opal(new Gem(StatType.CRIT_VALUE, 2520.0), new Gem(StatType.DAMAGE, 700.0), new Gem(StatType.ATTACK_SPEED, 0.017));
        ...
        Map<StatType, Double> twoHandBaseStats = new HashMap<>();
        twoHandBaseStats.put(StatType.DAMAGE, 24934.348);
        twoHandBaseStats.put(StatType.CRIT_VALUE, 2887.408);
        ...
        twoHand.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        twoHand.addEnchant(new Enchant(EnchantType.DAMAGE, 0.44776));
        twoHand.addGem(new Gem(StatType.DAMAGE, 700.0));
        twoHand.addGem(new Gem(StatType.DAMAGE, 700.0));
        twoHand.addGem(new Gem(StatType.DAMAGE, 700.0));
        twoHand.addGem(new Gem(StatType.DAMAGE, 700.0));
        twoHand.addGem(new Gem(StatType.DAMAGE, 700.0));
        ...
        Tonic tonic = new Tonic("Tonic of Vigor", StatType.DAMAGE, 10496.0);
