...
public class EquipmentLimitTest {
    ...
    void updateJewelTrinket_succeedsIfWithinJewelLimit() throws IllegalAccessException, NoSuchFieldException {
        Character character = new Character(CharacterClass.SPELLWEAVER, this.setFactory);
        character.updateJewelTrinket(0, new Jewel[]{jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.RAGE), jewelFactory.createJewel(JewelType.SCORCHING_RAY), jewelFactory.createJewel(JewelType.ETERNAL_SCORN), jewelFactory.createJewel(JewelType.ETERNAL_WRATH), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.AMBIDEXTROUS_VIGOR), jewelFactory.createJewel(JewelType.VITALITY)});
    ...
    {
        Character character = new Character(CharacterClass.SPELLWEAVER, this.setFactory);
        character.updateJewelTrinket(0, new Jewel[]{jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.RAGE), jewelFactory.createJewel(JewelType.SCORCHING_RAY), jewelFactory.createJewel(JewelType.ETERNAL_SCORN), jewelFactory.createJewel(JewelType.ETERNAL_WRATH), jewelFactory.createJewel(JewelType.GEM_FORTUNE), jewelFactory.createJewel(JewelType.AMBIDEXTROUS_VIGOR), jewelFactory.createJewel(JewelType.VITALITY)});

        Assertions.assertThrows(IllegalArgumentException.class, () -> character.updateJewelTrinket(1, new Jewel[]{jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.BLACK_KNIGHT_ORDER), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.VIGOR), jewelFactory.createJewel(JewelType.GLORY)}));
        Assertions.assertThrows(IllegalArgumentException.class, () -> character.updateJewelTrinket(1, new Jewel[]{jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.FOCUS), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.INGREDIENT_HUNTER), jewelFactory.createJewel(JewelType.VIGOR), jewelFactory.createJewel(JewelType.GLORY)}));
    }
}
